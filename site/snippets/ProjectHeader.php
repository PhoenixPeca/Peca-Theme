...
<body class="noHL" oncontextmenu="return false">
...
<a class="navbar-brand logo" href="<?php echo url('') ?>" title="Go to <?php echo $site->title()->html() ?> Home"><?php echo $site->title()->html() ?></a>
</div>
<?php snippet('Menu') ?>
</div>
</nav>